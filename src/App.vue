  ...
  <div class="app-container">
    ...
    <div class="content-wrapper">
      ...
      <div class="side-panel">
        <FurnitureDressingPanel @add-test-furniture="handleAddTestFurniture" />
      </div>
    </div>
...
import FurnitureDressingPanel from "./components/FurnitureDressingPanel.vue";
...
function handleAddTestFurniture() {
  if (threeSceneRef.value) {
    threeSceneRef.value.addTestFurniture();
    displayToast("测试家具已添加", "success");
  }
}
