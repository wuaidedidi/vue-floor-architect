<template>
  <div class="app-container">
    <Toolbar
      ...
      @clear="handleClear"
      @toggle-night-mode="handleToggleNightMode" />
...
function handleToggleNightMode() {
  if (threeSceneRef.value) {
    threeSceneRef.value.toggleNightMode();
    isNightMode.value = threeSceneRef.value.isNightMode;
    if (isNightMode.value) {
      displayToast("夜景模式已开启", "info");
    } else {
      displayToast("已切换回日间模式", "info");
    }
  }
}
