<template>
  <div class="toolbar">
    ...
    <div class="toolbar-actions">
      ...
      <!-- 家具模式 -->
      <button
        class="toolbar-btn furniture-btn"
        :class="{ active: editorStore.mode === 'furniture' }"
        @click="toggleFurnitureMode"
        title="家具换装">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
function toggleFurnitureMode() {
  if (editorStore.mode === "furniture") {
    editorStore.setMode("none");
  } else {
    editorStore.setMode("furniture");
  }
  emit("toggle-furniture");
}
</script>
...
.toolbar-btn.furniture-btn {
  background: rgba(236, 72, 153, 0.1);
  color: #ec4899;
  border-color: rgba(236, 72, 153, 0.3);
}

.toolbar-btn.furniture-btn:hover {
  background: rgba(236, 72, 153, 0.2);
  border-color: #ec4899;
}

.toolbar-btn.furniture-btn.active {
