...
const controlsRef = ref<THREE.OrbitControls | null>(null);
const rendererRef = ref<THREE.WebGLRenderer | null>(null);
const { isNightMode, activateNightMode, deactivateNightMode, toggleNightMode } = useNightMode(
  sceneRef,
  cameraRef,
  controlsRef,
  rendererRef,
